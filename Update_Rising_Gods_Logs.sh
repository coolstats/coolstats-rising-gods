...
printf "This updates only the Rising Gods data addon family:\n"
printf "  coolstats_Data_RisingGods plus generated UWU shard folders\n"
printf "Includes duplicate-name safeguards for reused Rising Gods character names.\n"
